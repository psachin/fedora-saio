...
for i in {5..10};
do
	swift-ring-builder object-2.builder add r1z1-127.0.0.1:6010/d${i} 2
done
...
for i in {1..10};
do
	swift-ring-builder container.builder add r1z1-127.0.0.1:6011/d${i} 1
done
...
for i in {1..10};
do
	swift-ring-builder account.builder add r1z1-127.0.0.1:6012/d${i} 1
done
